...
void SparkFun_APDS9960::delay(int millis) {
...
{
    return wireWriteDataBlock(APDS9960_I2C_ADDR, &val, 1);
}
...
{
    return wireWriteDataBlock(reg, &val, 1);
}
...
{
    return wireReadDataBlock(reg, &val, 1) > 0;
}
